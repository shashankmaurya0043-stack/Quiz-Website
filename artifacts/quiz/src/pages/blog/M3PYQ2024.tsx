...
const M3PYQ2024: React.FC = () => {
  ...
  const selectOption = (opt: string) => { const copy = [...selected]; copy[current] = opt; setSelected(copy); };
    ...
    return (
      <div className="min-h-screen flex items-center justify-center px-4 py-8" style={{ backgroundColor: "#0f172a" }}>
        <div className="max-w-lg w-full rounded-3xl shadow-2xl p-6 sm:p-8 text-center space-y-5" style={{ backgroundColor: "#1e293b", border: "2px solid #facc15" }}>
          ...
          <h1 className="text-3xl sm:text-4xl font-extrabold leading-tight" style={{ color: "#facc15" }}>M3-R5 PYQ<br /><span style={{ color: "#ffffff" }}>July 2024</span></h1>
