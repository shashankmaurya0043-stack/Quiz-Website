        ...
        <div className="mt-8 bg-white border-2 border-black rounded-3xl overflow-hidden shadow-[6px_6px_0px_0px_rgba(0,0,0,1)]">
          ...
          <div className="p-8">
            ...
            <p className="mt-5 text-zinc-700 text-lg leading-relaxed">
              ...
              concepts par based hain. Daily practice se aap M3 paper me
            ...
            <div className="mt-14">
              ...
              <div className="space-y-5">
                ...
                <div
                  onClick={() => navigate("/blog/m3-2025-pyq")}
                ...
                <div
                  onClick={() => navigate("/blog/m3-2024-pyq")}
                ...
                <div
                  onClick={() => navigate("/blog/m3-repeated-questions")}
